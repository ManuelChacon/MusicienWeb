(function() {
  ...
  angular.module('jkAngularCarousel', ['jkAngularCarousel.templates']);
})();
  ...
  function CarouselController($timeout, $attrs, $interval, $window) {
    ...
    that.scaleContent = function() {
      ...
      if (currentElementParentWidth < that.maxWidth) {
        ...
        var newHeight =
          that.maxHeight * currentElementParentWidth / that.maxWidth;
    ...
    that.scaleMarginLeft = function(newSlidesContainerWidth) {
      if (
        ...
        that.currentMarginLeftValue =
          that.currentMarginLeftValue * newSlidesContainerWidth;
        that.currentMarginLeftValue =
          that.currentMarginLeftValue / that.currentSlidesContainerWidth;
    ...
    that.applyMarginLeft = function() {
      that.slidesContainer.css(
        'margin-left',
        that.currentMarginLeftValue + 'px'
      );
    };
...
(function() {
  ...
  angular
    .module('jkAngularCarousel')
    .directive('jkCarousel', [CarouselDirective]);
})();

(function() {
  angular.module('jkAngularCarousel.templates', []).run([
    '$templateCache',
    function($templateCache) {
      $templateCache.put(
        'carousel-directive.html',
